...
RUN apt-get update && apt-get -y install firefox=36.0* flashplugin-installer=11.2.202.442* gstreamer1.0-pulseaudio gstreamer1.0-plugins-good ubuntu-restricted-extras
