...
RUN apt-get update && apt-get -y install --install-recommends firefox=36.0.4* flashplugin-installer=11.2.202.451* dbus-x11 pulseaudio gstreamer1.0-pulseaudio gstreamer1.0-plugins-good ubuntu-restricted-extras
